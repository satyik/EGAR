...
def train_and_eval(epochs=100, batch_size=128, lr=0.001):
    ...
    print(f"\n--- Advanced Training: SCALE-C4 on {device} ---")
    ...
    print(f"Total Parameters: {total_params:,} (Budget Hit: ~500k)")
    ...
    for epoch in range(epochs):
        ...
        if acc_top1 > best_acc:
            ...
            torch.save({
                ...
                'best_acc': acc_top1,
            }, "best_model_SCALE_C4_ADVANCED.pth")
            best_acc = acc_top1

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Advanced Training Pipeline for SCALE-C4")
