...
from models_cifar import create_scale_c4
...
def train_and_eval(epochs=10):
    ...
    print(f"\n--- Training Candidate SCALE-C4 on {device} ---")
    
    model = create_scale_c4()
    expected = 509264
    ...
    for epoch in range(epochs):
        ...
        if acc_top1 > best_acc:
            ...
            torch.save(model.state_dict(), "best_model_SCALE_C4.pth")
            best_acc = acc_top1

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train SCALE-C4 Architecture")
